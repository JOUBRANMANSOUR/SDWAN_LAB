...
class AnswerClaim(BaseModel):
    ...
    claim_type: Literal["site_status", "tunnel_status", "routing_rule", "routing_table", "route", "next_hop", "output_interface", "selected_hub", "selected_transport", "state_comparison", "event", "limitation"]
